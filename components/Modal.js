   ...
   return (
      <Backdrop onClick={handleClose}>
         ...
         {type === "gifYouUp" && (
            <motion.div
               onClick={(e) => e.stopPropagation()}
               className="rounded-lg flex bg-[#1D2226] w-full max-w-6xl h-4/6 -mt-[7vh] mx-6"
               variants={gifYouUp}
               initial="hidden"
               animate="visible"
               exit="exit"
            >
               ...
               />
               <div className="w-full md:w-3/5 bg-white dark:bg-[#1D2226] rounded-r-lg overflow-y-auto">
